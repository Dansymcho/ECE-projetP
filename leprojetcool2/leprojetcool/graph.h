...
private :
    ...
    grman::WidgetBox m_bindice;
    grman::WidgetText m_indice;
...
private :
    ...
    grman::WidgetButton m_bajoutera;
    grman::WidgetText m_ajoutera;
    grman::WidgetButton m_benlevera;
    grman::WidgetText m_enlevera;

    grman::WidgetButton m_bconnexe;
    grman::WidgetText m_connexe;
...
public:
    ...
    void Ajoutespece(std::map<int, Vertex> m_vertices);
    void Ajoutarete(std::map<int, Edge> m_edges);
    void Enleversommet();
    ...
    std::vector<int> connexite( int sommet);
    std::vector<std::vector<int>> connexitetot();
    void nbco( std::vector<std::vector<int>> tabc);
